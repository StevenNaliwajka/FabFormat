...
def write_solidlayer(Fout):
    ...
    Fout.write(f'G1 X{xstart} Y{ystart} F7500\n')  # mve nozel to lower corner
    zstart = zres
    # Fout.write('G1 Z%7.3' % zres,' F7800.000') # poition nozel
    Fout.write(f'G1 Z%7.3{zres} F7800.000')  # poition nozel
    for ii in range(0, zlayers - 1):
        ...
        Fout.write(f'G1 X%7.3{Xl} Y%7.3{Yl} E%7.3{Extr} F900\n')
...
for ii in range(2, len(filelist) - 1):
